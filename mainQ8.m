...
colorbar;
axis equal;
savefig('p2_4Q8 T Zhan_Zhongkun');
close;
% Plot q
figure;
scatter(x2_4, y2_4, []);
...
axis equal;
savefig('p2_4Q8 q Zhan_Zhongkun');
close;
...
colorbar;
axis equal;
savefig('p2_16Q8 T Zhan_Zhongkun');
close;
% Plot q
figure;
scatter(x2_16, y2_16, []);
...
axis equal;
savefig('p2_16Q8 q Zhan_Zhongkun');
close;
...
colorbar;
axis equal;
savefig('p2_100Q8 T Zhan_Zhongkun');
close;
% Plot q
figure;
...
axis equal;
savefig('p2_100Q8 q Zhan_Zhongkun');
close;
% Plot error
figure;
...
savefig('p2Q8 err Zhan_Zhongkun');
close;
...
colorbar;
axis equal;
savefig('p3_8Q8 T Zhan_Zhongkun');
close;
% Plot q
figure;
scatter(x3_8, y3_8, []);
...
axis equal;
savefig('p3_8Q8 q Zhan_Zhongkun');
close;
...
colorbar;
axis equal;
savefig('p3_94Q8 T Zhan_Zhongkun');
close;
% Plot q
figure;
scatter(x3_94, y3_94, []);
...
axis equal;
savefig('p3_94Q8 q Zhan_Zhongkun');
close;
...
colorbar;
axis equal;
savefig('p3_163Q8 T Zhan_Zhongkun');
close;
% Plot q
figure;
...
axis equal;
savefig('p3_163Q8 q Zhan_Zhongkun');
close;
% Plot error
figure;
...
savefig('p3Q8 err Zhan_Zhongkun');
close;
